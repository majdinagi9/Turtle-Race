...
def finish_line():
    ...
    for j in range(10):
        turtle.setpos(finish_line + square_size,
                      ((180 - square_size) - (j * square_size * 2)))
        turtle.stamp()
    turtle.hideturtle()
...
def raceStarting():
    ...
    if (turtleOne.xcor() > 250):
        ...
        turtle.color("red")
        turtle.write(
            "Red Turtle Won", font=("Arial", 24, "italic"), align="center")
    elif (turtleTwo.xcor() > 250):
        turtle.goto(0, -200)
        turtle.color("blue")
        turtle.write(
            "Blue Turtle Won", font=("Arial", 24, "italic"), align="center")
    else:
        turtle.goto(0, -200)
        turtle.color("green")
        turtle.write(
            "Green Turtle Won", font=("Arial", 24, "italic"), align="center")
